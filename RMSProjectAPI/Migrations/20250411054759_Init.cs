        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedPreparationTime = table.Column<TimeSpan>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteMeals_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FavoriteMeals_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemSuggestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItemSuggestions_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuItemSuggestions_MenuItems_SuggestedItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteMeals_MenuItemId",
                table: "FavoriteMeals",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemSuggestions_MenuItemId",
                table: "MenuItemSuggestions",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemSuggestions_SuggestedItemId",
                table: "MenuItemSuggestions",
